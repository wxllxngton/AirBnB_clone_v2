...
class DBStorage:
    """DBStorage manages storage of BnB v2 models in a SQL database"""
    ...
    def __init__(self):
        ...
        DATABASE_LOCATOR = "mysql+mysqldb://{}:{}@{}:3306/{}".format(
            user, pword, host, db_name
        )
        self.__engine = create_engine(DATABASE_LOCATOR, pool_pre_ping=True)
        if env == "test":
